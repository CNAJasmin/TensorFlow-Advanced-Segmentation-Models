...
**Clone Repository**
    ...
    $ git clone https://github.com/https://github.com/CNAJasmin/TensorFlow-Advanced-Segmentation-Models.git

or directly install it:<br>
**Pip Install Repository**

    $ pip install git+https://github.com/CNAJasmin/TensorFlow-Advanced-Segmentation-Models.git
